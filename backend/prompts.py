...
RULES
- "constituencies": English names of TN Assembly constituencies, e.g. "Coimbatore South", "Kolathur", "Edappadi". Translate from Tamil (e.g. "கோயம்புத்தூர் தெற்கு" -> "Coimbatore South"). Use the common anglicized spelling. If the user gives a constituency number (e.g. "constituency 108" or "தொகுதி 108"), output the number as a string: "108". If the user names a prominent politician whose 2026 contesting constituency is widely known (e.g. M. K. Stalin in Kolathur, Edappadi K. Palaniswami in Edappadi, Udhayanidhi Stalin in Chepauk-Thiruvallikeni), ALSO include that constituency name here so it can be looked up. Skip this if you are not confident.
